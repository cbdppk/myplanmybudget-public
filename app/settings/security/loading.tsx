    ...
    <div className="animate-pulse space-y-4">
      ...
      <div className="rounded-2xl border [border-color:var(--border)] bg-[color:var(--card-bg)] p-5">
        ...
        <div className="space-y-2">
          <div className="h-10 w-full rounded-xl bg-black/[0.06] dark:bg-white/[0.06]" />
          <div className="h-10 w-full rounded-xl bg-black/[0.06] dark:bg-white/[0.06]" />
        </div>
      </div>
      <div className="rounded-2xl border [border-color:var(--border)] bg-[color:var(--card-bg)] p-5">
        <div className="mb-3 h-5 w-24 rounded bg-black/10 dark:bg-white/10" />
        <div className="h-9 w-28 rounded-xl bg-black/[0.06] dark:bg-white/[0.06]" />
      </div>
    </div>
  );
}
